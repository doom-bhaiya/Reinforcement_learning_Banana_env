...
from config import BUFFER_SIZE, BATCH_SIZE, GAMMA, TAU, LR, UPDATE_EVERY
...
class Agent():
    ...
    def __init__(self, state_size, action_size):
        ...
        # Q-Network
        self.qnetwork_local = FullyConnectedModel(state_size, action_size).to(device)
        self.qnetwork_target = FullyConnectedModel(state_size, action_size).to(device)
